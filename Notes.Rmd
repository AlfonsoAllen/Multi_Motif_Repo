...
Alfonso: If we define "closeness" and foraging distances, we could implement the above restrictions. For example, our algorithms can be adapted to take into account Chebyshev (o chess) distance (see Moore's neighboorhood).
