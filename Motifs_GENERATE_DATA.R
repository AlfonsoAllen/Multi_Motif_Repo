...
write_csv(visit_list, "Motifs/Caracoles.csv")

########################################################################
# NULL MODEL
########################################################################

abundances <- read_csv2("abundances.csv")
...
for (count_i in 1:100){
  ...
  print(paste("Motifs/random_",count_i,".csv",sep = ""))
  
  write_csv(rd_visit_list, paste("Motifs/random_",count_i,".csv",sep = ""))
