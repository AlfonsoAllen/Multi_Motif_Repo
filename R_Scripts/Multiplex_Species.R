...
list_incid_matrix_19 <- frame2webs(testdata_19,type.out="list")
  ...
  for (j in 1:length(list_incid_matrix_19)){
    ...
    layer_csv <- paste("Processed_data/Multilayer_Species/Plot_",i,"_layer_",names(list_incid_matrix_19)[plant_i],".csv",sep="")
...
for (j in 1:length(list_incid_matrix_19)){
    ...
    layer_csv <- paste("Processed_data/Multilayer_Species/Caracoles_layer_",names(list_incid_matrix_19)[plant_i],".csv",sep="")
    write.csv(incid_matrix_i,layer_csv)
}
