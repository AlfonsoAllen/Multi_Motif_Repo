...
data_simulation_raw <- read_csv("Processed_data/Data_simulation/data_changing_individuals_V3.csv")
...
for (Plot_i in list_sites){
  ...
  # Extract conespecific and heterospecif probabilities for Plot_i
  ...
  write_csv(stationary_probabilities_consp_heter_final,"Processed_data/Data_simulation/data_changing_INDIVIDUALS_PROBABILITIES_V3.csv")
