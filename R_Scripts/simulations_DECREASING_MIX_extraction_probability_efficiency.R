...
data_simulation_raw <- read_csv("Processed_data/Data_simulation/data_decreasing_mix_V2.csv")
...
for (Plot_i in list_sites){
  ...
  write_csv(stationary_probabilities_consp_heter_final,"Processed_data/Data_simulation/data_changing_decreasing_mix_PROBABILITIES.csv")
