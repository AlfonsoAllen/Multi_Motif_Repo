...
centrality <- read_csv("NN_PageRank_results.csv") %>%
...
write_csv(fitness_final,"NN_data_models_phenol_overlap.csv")


fitness_final %>% group_by(Plant_Simple) %>% count(wt=visits_GF)
