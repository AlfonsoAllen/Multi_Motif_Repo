...
G_F_list_to$G_F[G_F_list_to$node_to=="Odontomyia_sp."] <- "Hoverflies"
G_F_list_to <- unique(G_F_list_to)

G_F_list_from$G_F[G_F_list_from$node_from=="Odontomyia_sp."] <- "Hoverflies"
...
GF_cz_edge_module_info_OUT %>% filter(!G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA")) #217 visitors 

#HUBS
GF_cz_edge_module_info_OUT %>% filter(G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA"),z>2.6) #0 plants
GF_cz_edge_module_info_OUT %>% filter(!G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA"),z>2.6) #4 animal
...
GF_cz_edge_module_info_OUT %>% filter(!G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA"),c<.6) #2 animal
...
GF_cz_edge_module_info_IN %>% filter(!G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA")) #217 visitors 
...
#Perip
GF_cz_edge_module_info_IN %>% filter(G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA"),c<.6) #21 plants
GF_cz_edge_module_info_IN %>% filter(G_F %in% c("LEMA","CHFU","CHMI","ME","PUPA"),c<.6)%>%
  group_by(layer_to,Plot) %>% count() %>% arrange(Plot) #21 plants
