...
source("R_scripts/random_plot_edge_list_plants2.R")
source("R_scripts/random_plot_edge_list_organism.R")
source("R_scripts/random_plot_edge_list_plant_organism.R")
source("R_scripts/random_plot_edge_list_plant_organism2.R")
...
# write_csv(results_test,paste0("NN_results_test_modules_NULL2_",Plot_i,".csv"))
...
# # Commented for security reasons
# results_test <- tibble(L=list_L,m=list_m,Plot=list_Plot,OBS=list_OBS)
# write.csv(results_test,"results_test_modules_NULL2.csv")

results_test <- read_csv("R_Scripts/NN_results_test_modules_NULL2_9.csv")
