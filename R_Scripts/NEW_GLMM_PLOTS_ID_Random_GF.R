...
GF_all_sp <- glmmTMB(Seeds_GF ~ scale(homo_motif) +
                       scale(hete_motif) + 
                       scale(Real_PR_Layer) + scale(Delta) + 
                       (1 | Plant_Simple) + 
                       (1 | G_F)+ 
                       (1 | Plot),
                     family = nbinom2(),
...
plotResiduals(res_LEMA_01, fitness_LEMA$Real_PR_Multi)
...
plotResiduals(res_PUPA_01, fitness_PUPA$Real_PR_Multi)
plotResiduals(res_PUPA_01, fitness_PUPA$Delta)
#
...
plotResiduals(res_CHFU_01, fitness_CHFU$Real_PR_Layer)
plotResiduals(res_CHFU_01, fitness_CHFU$Delta)
